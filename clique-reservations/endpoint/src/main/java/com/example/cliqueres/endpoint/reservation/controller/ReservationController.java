...
public class ReservationController {
  ...
  @RequestMapping("/save")
  public ResponseEntity<ReservationOut> save(ReservationPersistCommand reservation) {
  ...
  @PutMapping("/update")
  public ResponseEntity<ReservationOut> update(ReservationPersistCommand reservation) {
